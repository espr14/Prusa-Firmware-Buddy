...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 65     // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 220        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 131.37             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.43, 0, -1.37 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 104.32              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.61, 0.12, -0.73 } // Get these values from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 100*MS_MULT, 100*MS_MULT, 100*MS_MULT, 325 }
...
#ifdef USE_PRUSA_EEPROM_AS_SOURCE_OF_DEFAULT_VALUES
    #define DEFAULT_Z_MAX_POS MANUAL_Z_HOME_POS
...
#define NOZZLE_PARK_FEATURE
    ...
    #define NOZZLE_PARK_POINT_M600 { 0, (Y_MIN_POS + 10), 20 }
